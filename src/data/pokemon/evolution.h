const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWHIRL]  = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_POLIWRATH},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_POLITOED}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO},
                            {EVO_ITEM, ITEM_MOON_STONE, SPECIES_SLOWKING}},
    ...
    [SPECIES_PORYGON]    = {{EVO_LEVEL, 35, SPECIES_PORYGON2}},
    ...
    [SPECIES_HOPPIP]     = {{EVO_LEVEL, 14, SPECIES_SKIPLOOM}},
    ...
    [SPECIES_SLUGMA]     = {{EVO_LEVEL, 25, SPECIES_MAGCARGO}},
    ...
    [SPECIES_WAILMER]    = {{EVO_LEVEL, 32, SPECIES_WAILORD}},
    ...
    [SPECIES_ELECTRIKE]  = {{EVO_LEVEL, 24, SPECIES_MANECTRIC}},
    [SPECIES_NUMEL]      = {{EVO_LEVEL, 28, SPECIES_CAMERUPT}},
    [SPECIES_SPHEAL]     = {{EVO_LEVEL, 25, SPECIES_SEALEO}},
    [SPECIES_SEALEO]     = {{EVO_LEVEL, 35, SPECIES_WALREIN}},
    [SPECIES_CACNEA]     = {{EVO_LEVEL, 28, SPECIES_CACTURNE}},
